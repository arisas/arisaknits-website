<template>
  <div>
    <svg v-if="props.icon == 'check'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.4 11.9" fill="currentColor"
    ...
    <svg v-if="props.icon == 'briefcase'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.4 96.9" fill="currentColor"
      :width="props.width" :height="props.height">
      <path
    ...
    <svg v-if="props.icon == 'star'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124.5 118.8" fill="currentColor"
      :width="props.width" :height="props.height">
      <path
